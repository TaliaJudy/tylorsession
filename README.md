...
<body>
  <div class="container">
    <div class="main">
      <div class="box" id="box">
        <div id="text">
          <h3 class="centered-text">𝚻𝐘𝐋𝚯𝚪 𝚳𝐃 𝚩𝚯𝚻 PAIRING
          CODE</h3><br>
          <h6>Made 𝚻𝐘𝐋𝚯𝚪 🏴‍☠️.</h6>
          <h6>Enter Your Number with Country Code.</h6>
          <div class="input-container">
            <input type="number" id="number" placeholder=
            "Enter your Phone Pumber with Cuntry Code" name="">
            <button id="submit">Submit</button>
          </div><a id="waiting-message" class="centered-text"
          style="display: none;">Please wait a while</a><br>
          <br>
          <main id="pair"></main>
        </div>
      </div>
  ...
  <script src=
  "https://cdnjs.cloudflare.com/ajax/libs/axios/1.0.0-alpha.1/axios.min.js"></script>
